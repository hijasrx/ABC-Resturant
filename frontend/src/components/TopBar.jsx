...
const Topbar = () => {
  ...
  return (
    <div className="navbar-custom" style={topbarStyle}>
          ...
          <Link to="/dashboard/cart">
            <li className="d-none d-sm-inline-block">
              <div className="nav-link" id="cart-icon">
                <i className="ri-shopping-cart-line fs-22" style={iconStyle}></i>
              </div>
            </li>
          </Link>
          ...
          <li className="dropdown">
            ...
            <div className="dropdown-menu dropdown-menu-end dropdown-menu-animated profile-dropdown">
              ...
              <Link to="profile" className="dropdown-item">
                <i className="ri-account-circle-line fs-18 align-middle me-1" style={iconStyle}></i>
                <span>My Account</span>
              </Link>
              {/* item */}
              <button onClick={handleLogout} className="dropdown-item">
                <i className="ri-logout-box-line fs-18 align-middle me-1" style={iconStyle}></i>
                <span>Logout</span>
              </button>
            </div>
          </li>
