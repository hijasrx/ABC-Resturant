...
const ResetPassword = () => {
  ...
  return (
    <div className="authentication-bg" style={{ backgroundColor: '#494947' }}>
      <Alert />
      <div className="account-pages pt-2 pt-sm-5 pb-4 pb-sm-5 position-relative">
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-xxl-8 col-lg-10">
              <div className="card overflow-hidden" style={{ backgroundColor: '#494947', color: 'black' }}>
                  ...
                  <div className="col-lg-12">
                    <div className="d-flex flex-column h-100">
                      ...
                      <div className="p-4 my-auto">
                        <h4 className="fs-20" style={{ color: 'black' }}>Reset Password</h4>
                        ...
                        <form onSubmit={formik.handleSubmit}>
                          <div className="mb-3">
                            <label htmlFor="verificationCode" className="form-label" style={{ color: 'black' }}>
                              Verification Code
                            </label>
                            <input
          ...
          <div className="row">
            <div className="col-12 text-center">
              <p className="text-dark-emphasis" style={{ color: 'black' }}>
                Back To <Link to="/login" className="text-dark fw-bold ms-1 link-offset-3 text-decoration-underline"><b>Log In</b></Link>
              </p>
            </div>
            {/* end col */}
          </div>
